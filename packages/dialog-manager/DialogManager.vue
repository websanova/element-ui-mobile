        ...
        methods: {
            ...
            confirm(message, title, opts) {
                return this.dialog(message, {
                    ...
                    footer: (
                        <div>
                            <el-button on-click={this.handleCancel}>Cancel</el-button>
            ...
            handleFormError(res, form, data) {
                this.formError = true
                if (this.currentDialog.onError) this.currentDialog.onError(res, form)
            },
            handleAccept() {
                this.close(true)
            },
            ...
            renderDialog(dialogs) {
                ...
                const { __closePromise, __closeReject, __closeResolve, ...dialog } = dialogs[
                    this.currentIndex
                ]
                                ...
                                class={[
                                    this.backdropClass,
                                    {
                                        [`${this.backdropClass}--open`]:
                                            this.dialogs.length > 1 || (this.visible && this.hasDialog),
                                    },
                                ]}
                            />
                        )}
