<script>
    ...
    export default {
        ...
        methods: {
            scrollPrev() {
                let containerSize = this.$refs.navWrap[
            ...
            scrollToActiveTab() {
                ...
                if (!activeTab) return;
                const navScroll = this.$refs.navWrap;
            ...
            update() {
                ...
                const offsetProp = `offset${firstUpperCase(sizeName)}`;
                let navSize = this.$refs.nav[offsetProp];
                let containerSize = this.$refs.navWrap[offsetProp];
                const currentOffset = this.navOffset;
                ...
                if (containerSize < navSize) {
                    ...
                    if (navSize - currentOffset < containerSize) {
                        this.navOffset = navSize - containerSize + arrowSize;
                    }
                } else {
